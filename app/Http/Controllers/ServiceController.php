...
class ServiceController extends Controller
{
    ...
    public function edit(Service $service)
    {
        ...
        return view('backend.service.edit', compact('service','brand'));
    }
...
//        return back()->withSuccess(trans('Updated success', [ 'entity' => 'Service' ]));
        return redirect()->route('service.index', $brandId)->withSuccess(trans('messages.update_success', ['entity' => 'service']));
    }
