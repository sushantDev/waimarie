                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            {{ Form::select('category', $servicecategorys) }}
                        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        @if(isset($servicephoto) && $servicephoto->image)
                            <input type="file" name="image" class="dropify"
                                   data-default-file="{{ asset($servicephoto->image->path)}}"/>
                        @else
                            <input type="file" name="image" class="dropify"/>
                        @endif
                      </div>
...
<br>
    ...
    <div class="col-sm-4">
          <div class="card card-affix affix-4">
              <div class="card-head">
                  <div class="tools">
                      <a class="btn btn-default btn-ink" href="{{ route('servicephoto.index') }}">
                          <i class="md md-arrow-back"></i>
                          Back
                      </a>
                  </div>
              ...
              <div class="card-actionbar">
                  <div class="card-actionbar-row">
                      ...
                      <input type="submit" name="publish" class="btn btn-primary ink-reaction" value="{{ isset($servicephoto) && $servicephoto->is_published ? 'Save' : 'Publish' }}">
                  </div>
              </div>
          </div>
      </div>
