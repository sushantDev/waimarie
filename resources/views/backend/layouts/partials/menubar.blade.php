...
<div id="menubar" class="animate">
    <div class="menubar-fixed-panel">
        ...
        <div class="expanded">
            <a href="{{ url('/') }}">
                <span class="text-lg text-bold text-primary text-uppercase" style="color:#2196f3;">{{ str_replace('_', ' ',config('app.name')) }}</span>
            </a>
        </div>
    ...
    <div class="menubar-scroll-panel">
        ...
        <div class="menubar-foot-panel">
            <small class="no-linebreak hidden-folded">
                <span class="opacity-75">Copyright &#183; {{ date('yy-d-M') }} &#183;</span>
                <strong>
