                        ...
                        <div class="col-sm-12">
                            ...
                            @if(isset($gallerycategory) && $gallerycategory->image)
                                <input type="file" name="image" class="dropify"
                                       data-default-file="{{ asset($gallerycategory->image->path) }}"/>
                            @else
                                <input type="file" name="image" class="dropify"/>
                            @endif
                        </div>
        ...
        <div class="card card-affix affix-4">
            ...
            <div class="card-actionbar">
                <div class="card-actionbar-row">
                    ...
                    <input type="submit" name="draft" class="btn btn-info ink-reaction" value="Save Draft">
                    <input type="submit" name="publish" class="btn btn-primary ink-reaction" value="{{ isset($gallerycategory) && $gallerycategory->is_published ? 'Save' : 'Publish' }}">
                </div>
            </div>
        </div>
    </div>
