			...
			<div class="row">
				<div class="col-lg-4">
					...
					<div class="footer-important-link">
						...
						<ul>
							<li><a href="/service/#coursesworkshopsgroups">COURSES/GROUPS</a></li>
							<li><a href="/roomhire">ROOM HIRE</a></li>
							<li><a href="/service/#vegetable-fruit-box-11">VEGETABLE AND FRUIT BOX $11</a></li>
							<li><a href="/service/#legal-advice">LEGAL ADVICE</a></li>
							<li><a href="/service/#budgeting-advice">BUDGETING ADVICE</a></li>
							<li><a href="/service/#benefithousing-nzacc-advocacy">Benefit/Housing NZ/ACC Advocacy</a></li>
							<li><a href="/service/#events">EVENT</a></li>
						</ul>
					</div>
				</div>
					...
					{{--<blockquote class="instagram-media" data-instgrm-captioned--}}
						...
						{{--<div style="padding:16px;"> <a--}}
							...
							{{--<p style=" margin:8px 0 0 0; padding:0 4px;"> <a--}}
										...
										{{--target="_blank">Meditation Course starting soon. Learn the art of being a whole--}}
									{{--person with Pam Chiles. Register via--}}
									{{--https://docs.google.com/forms/d/e/1FAIpQLSfOYNrC6JisAdzESJxpAxmtdqSPzf3JQC7fgo4brGiMdUpH0A/viewform</a>--}}
							{{--</p>--}}
							{{--<p--}}
									{{--style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;">--}}
								{{--A post shared by <a--}}
										{{--href="https://www.instagram.com/waimariecommunityhouse/?utm_source=ig_embed&amp;utm_campaign=loading"--}}
										{{--style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px;"--}}
										{{--target="_blank"> WaimarieCommunityHouse</a> (@waimariecommunityhouse) on <time--}}
										{{--style=" font-family:Arial,sans-serif; font-size:14px; line-height:17px;"--}}
										{{--datetime="2019-02-21T22:19:24+00:00">Feb 21, 2019 at 2:19pm PST</time></p>--}}
						{{--</div>--}}
					{{--</blockquote>--}}
					{{--<script async src="//www.instagram.com/embed.js"></script>--}}

					<iframe src="https://snapwidget.com/embed/891053" class="snapwidget-widget" allowtransparency="true"
							frameborder="0" scrolling="no" style="border:none; overflow:hidden;  width:370px; height:330px"></iframe>
			...
			<div class="row">
				...
				<div class="col-lg-9">
					<div class="footer-address text-left">
						<ul>
							<li class="ml-0"><i class="fa fa-map-marker"></i>
								{{setting('address')}}
							</li>
							<li><i class="ion-iphone"></i> {{setting('phone')}} </li>
							<li><i class="ion-forward"></i> {{setting('email')}} </li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3">
					<div class="footer-social-icon text-right">
						<ul>
							...
							{{--<li><a href="{{setting('vimeo')}}" target="_blank"><i class="fa fa-vimeo"></i></a></li>--}}
						</ul>
					</div>
				</div>
